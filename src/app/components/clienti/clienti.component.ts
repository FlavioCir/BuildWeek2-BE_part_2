...
export class ClientiComponent implements OnInit {
  ...
  addCliente(form: NgForm): void {
    ...
    this.cs.addClienti(nuovoCliente).subscribe(
      response => console.log('Cliente aggiunto:', response),
      error => console.error('Errore durante l\'aggiunta del cliente:', error),
    );
  }
