...
export class FattureComponent implements OnInit {
  ...
  addFattura(form: NgForm) {
    ...
    this.fs.addFatture(nuovaFattura).subscribe(
      response => console.log('Fattura aggiunta:', response),
      error => console.error('Errore durante l\'aggiunta della fattura:', error)
    );
