...
export class IndirizziComponent implements OnInit {
  ...
  addIndirizzo(form: NgForm) {
    ...
    this.is.addIndirizzi(nuovoIndirizzo).subscribe(
      respone => console.log('Indirizzo aggiunto:', respone),
      error => console.error('Errore durante l\'inserimento dell\'indirizzo:', error)
    );
  }
